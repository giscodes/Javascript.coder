			...
			<article class="detalle-grid">
				...
				<div class="detalles-content">
					<h3>${producto.title}</h3>
						...
						<p class="description">
							<b>Descripcion: </b> <span>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Deleniti, eos molestiae exercitationem aut accusantium eaque expedita provident, repudiandae necessitatibus ratione ad, quos optio consequuntur? Amet, laborum! Repellendus neque omnis exercitationem</span>
						</p>
  ...
  getButtons() {
    ...
    buttons.forEach((button) => {
      ...
      button.addEventListener("click", (e) => {
        ...
        Swal.fire({
          title: "Exito!",
          text: "Se añadió este producto al carrito",
          icon: "success",
